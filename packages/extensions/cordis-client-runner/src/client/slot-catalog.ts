...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.attribution',
    kind: 'single',
    scope: 'root',
    summary: 'Deployment self-identification under the blank-session headline; unoccupied renders nothing.',
    doc: 'Deployment self-identification under the blank-session headline; unoccupied renders nothing.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'experimental-client-ui-brand-forge ForgeAttribution',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-brand-forge ForgeBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
