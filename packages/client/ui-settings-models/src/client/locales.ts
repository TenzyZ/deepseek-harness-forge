...
export const en = {
  ...
  modelDetails: 'Model capabilities',
  modelReasoning: 'Supported reasoning efforts',
  modelReasoningInherit: 'Use catalog capability',
  modelReasoningDisabled: 'No reasoning support',
  modelReasoningCustom: 'Choose supported levels',
  modelReasoningSupported: 'Supported effort',
  modelReasoningWire: 'Provider wire value',
  modelReasoningOmit: 'Empty: omit the effort parameter',
  modelReasoningInvalid: 'Choose at least one thinking level and enter its provider wire value. Only off may be empty.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  modelDetails: '模型能力',
  modelReasoning: '支持的推理等级',
  modelReasoningInherit: '使用目录能力',
  modelReasoningDisabled: '不支持推理',
  modelReasoningCustom: '选择支持的等级',
  modelReasoningSupported: '支持的等级',
  modelReasoningWire: '提供商请求值',
  modelReasoningOmit: '留空：不发送推理参数',
  modelReasoningInvalid: '请至少选择一个思考等级并填写提供商请求值。只有 off 可以留空。',
  addModel: '添加模型',
  removeModel: '删除模型',
